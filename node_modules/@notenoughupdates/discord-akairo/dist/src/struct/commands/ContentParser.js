...
exports.ContentParserResult = exports.ExtractedFlags = exports.ContentParserOptions = exports.ContentParser = exports.ParserOptions = void 0;
...
(function (TokenizerState) {
    TokenizerState[TokenizerState["Default"] = 0] = "Default";
    TokenizerState[TokenizerState["Quotes"] = 1] = "Quotes";
    TokenizerState[TokenizerState["SpecialQuotes"] = 1] = "SpecialQuotes";
...
const ParsedOptionFlag = BaseParsed.extend({
    type: zod_1.z.literal("OptionFlag"),
    key: zod_1.z.string(),
    value: zod_1.z.string()
}).passthrough();
